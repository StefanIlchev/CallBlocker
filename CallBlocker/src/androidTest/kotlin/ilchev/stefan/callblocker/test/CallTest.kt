...
class CallTest(
	...
	private fun assertBlocked(context: Context) {
		...
		val isBlockedActual = blockPredicate(incomingNumber)
		Assert.assertEquals(isBlockedExpected, isBlockedActual)
	}
	...
	companion object {
		...
		fun data() = arrayOf(
			...
			arrayOf(false, false, "a", true, "a", null, false),
			...
			arrayOf(false, false, "a", false, "a", null, true),
			...
			arrayOf(false, true, "a", true, "a", null, false),
			...
			arrayOf(false, true, "a", false, "a", null, true),
			...
			arrayOf(true, false, "a", true, "a", null, false),
			...
			arrayOf(true, false, "a", false, "a", null, true),
			...
			arrayOf(true, true, "a", true, "a", null, false),
			...
			arrayOf(true, true, "a", false, "a", null, true),
