...
import stef40.about.tryStartAboutActivity
import stef40.base.applyWindowInsetsListener
import stef40.base.isActivityFound
import stef40.base.requestedPermissions
import stef40.base.sharedPreferences
import stef40.base.tryStartActivityForResult
import stef40.base.tryStartForegroundService
import stef40.base.tryStopService
...
class MainActivity : Activity() {
	...
	private var isInstallPackagesRequester
		get() = usableUpdateServiceType != null ||
	...
	private fun callUpdateService() {
		val service = updateServiceType?.let { (intent?.let(::Intent) ?: Intent()).setClass(this, it) }
		if (isStopIntent) {
			service?.let { tryStopService(it) }
			finish()
		} else if (service != null && packageManager.canRequestPackageInstalls()) {
	...
	override fun onOptionsItemSelected(
		...
		R.id.about -> {
			tryStartAboutActivity(getString(R.string.app_name))
			true
		}
