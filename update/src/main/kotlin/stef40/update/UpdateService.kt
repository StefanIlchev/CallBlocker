...
import stef40.base.NOTIFICATION_ID
import stef40.base.getPackageInfo
import stef40.base.getParcelableExtra
import stef40.base.mainHandler
import stef40.base.registerExportedReceiver
...
class UpdateService : Service() {
	...
	private fun startForeground(stopIntent: PendingIntent) {
		...
		val builder = Notification.Builder(this, packageName)
		...
		if (manager != null) {
			val channel = NotificationChannel(packageName, applicationLabel, NotificationManager.IMPORTANCE_MIN)
	...
	private fun startUpdateInstall(file: File, versionName: String, workHandler: Handler) {
		...
		val intent = Intent(packageName).setPackage(packageName)
